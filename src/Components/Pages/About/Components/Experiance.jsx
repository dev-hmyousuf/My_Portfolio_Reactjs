    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-[60px] xl:gap-[134px]">
        ...
        <div className="flex flex-col justify-end">
          ...
          <div className="px-6 py-6 bg-black rounded-lg flex flex-wrap justify-between items-end group">
            <div className="flex flex-col flex-wrap gap-y-2">
              <span className="text-orange text-lg font-normal leading-none">
                SAY HELLO!
              </span>
              <h4 className="text-white text-xl xl:text-[25px] font-bold font-Syne leading-none">
