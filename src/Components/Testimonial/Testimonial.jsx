const testimonialsData = [
    ...
    {
      text: "Unleash energistically build alternative scenarios via cross-unit build efficient initiatives for distinctive vortals. Synergistically strategize via adaptive.",
      author: "Jane Doe",
    },
    {
      text: "Unleash energistically build alternative scenarios via cross-unit build efficient initiatives for distinctive vortals. Synergistically strategize via adaptive.",
        ...
        <div className="px-8 xl:pr-0 xl:pl-[4%] 2xl:pl-[6%] 3xl:pl-[17%]">
          <div className="flex flex-col xl:flex-row gap-x-[55px] 2xl:gap-x-[100px] 3xl:gap-x-[165px]">
            ...
            <div className="swiper w-full ">
              <div className="swiper-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {testimonialsData.map((item, index) => (
                  <TestimonialCard key={index} testimonial={item.text} author={item.author} />
                ))}
              </div>
            </div>
          </div>
